...
public class AdminContentUpdateJob extends TimeBaseEntity {
    ...
    private AdminContentUpdateJob(StreamingStatus status, LocalDateTime scheduledAt,
            Long adminId,
    ...
    public static AdminContentUpdateJob of(StreamingStatus status, Long adminId,
            Long contentId,
